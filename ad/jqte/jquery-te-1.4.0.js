...
(function($){		
	$.fn.jqte = function(options){
		...
		addParams('sub','subscript','(',["sub"],false); // sub script --> ctrl + down arrow
		...
		addParams('strike','strikeThrough','K',["strike"],false); // strike through --> ctrl + K
		addParams('link','linkcreator','L',["a"],false); // insertion link  --> ctrl + L
		...
		return this.each(function(){
			...
			jQTE.html('<div class="'+vars.css+"_toolbar"+'" role="toolbar" unselectable style="width300px"></div><div class="'+vars.css+'_linkform" style="display:none" role="dialog"></div><div class="'+vars.css+"_editor"+'" style="height: 460px; width:300px"></div>');
